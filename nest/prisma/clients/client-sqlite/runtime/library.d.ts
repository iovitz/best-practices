...
export declare interface DynamicClientExtensionThisBuiltin<TypeMap extends TypeMapDef, TypeMapCb extends TypeMapCbDef, ExtArgs extends Record<string, any>, ClientOptions> {
  $extends: ExtendsHook<'extends', TypeMapCb, ExtArgs, Call<TypeMapCb, {
    extArgs: ExtArgs
  }>, ClientOptions>
  $transaction: (<P extends PrismaPromise<any>[]>(arg: [...P], options?: {
    isolationLevel?: TypeMap['meta']['txIsolationLevel']
  }) => Promise<UnwrapTuple<P>>) & (<R>(fn: (client: Omit<DynamicClientExtensionThis<TypeMap, TypeMapCb, ExtArgs, ClientOptions>, ITXClientDenyList>) => Promise<R>, options?: {
    maxWait?: number
    timeout?: number
    isolationLevel?: TypeMap['meta']['txIsolationLevel']
  }) => Promise<R>)
...
export declare interface InternalArgs<R = {
  [K in string]: {
    [K in string]: unknown;
  };
}, M = {
 ...
 * Class that holds the list of all extensions, applied to particular instance,
 well as resolved versions of the components that need to apply on
...
declare interface WasmLoadingConfig {
  /**
