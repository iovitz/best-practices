...
export namespace Prisma {
  ...
  */
  ...
  export const DemoOrderByRelevanceFieldEnum: {
    name: 'name'
  };

  export type DemoOrderByRelevanceFieldEnum = (typeof DemoOrderByRelevanceFieldEnum)[keyof typeof DemoOrderByRelevanceFieldEnum]
  ...
  export type DemoOrderByWithRelationInput = {
    id?: SortOrder
    name?: SortOrder
    _relevance?: DemoOrderByRelevanceInput
  }
  ...
  export type DemoOrderByRelevanceInput = {
    fields: DemoOrderByRelevanceFieldEnum | DemoOrderByRelevanceFieldEnum[]
    sort: SortOrder
    search: string
  }
